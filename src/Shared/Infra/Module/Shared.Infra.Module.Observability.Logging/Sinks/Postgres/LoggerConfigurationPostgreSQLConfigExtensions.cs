...
namespace Shared.Infra.Module.Observability.Logging.Sinks.Postgres
{
    public static class LoggerConfigurationPostgreSQLConfigExtensions
    {
        ...
        /// <param name="needAutoCreateDatabase">Set if sink should create database if not exists</param>
            ...
            bool needAutoCreateDatabase = false)
        {
            ...
            if (!connectionString.Contains("="))
                realConnectionString = configuration.GetConnectionString(connectionString) ?? connectionString;
            ...
            return sinkConfiguration.Sink(new PostgreSQLSink(realConnectionString,
                                                                ...
                                                                schemaName,
                                                                needAutoCreateTable,
                                                                needAutoCreateDatabase), restrictedToMinimumLevel, levelSwitch);
        }
    }
}
