...
public class ErrorHandlingModule : IWebModule
{
    ...
    public void ConfigureHost(WebApplicationBuilder builder)
    {
        ...
        if (_options.ModelStateValidation?.Enabled != false)
        {
            builder.Services.Configure<ApiBehaviorOptions>(options =>
            {
                if (_options.ModelStateValidation.SuppressModelStateInvalidFilter == true)
                {
                    options.SuppressModelStateInvalidFilter = true;
                }

                if (_options.ModelStateValidation.SuppressMapClientErrors == true)
                {
